...
- **Fleet (Logistics & Vehicle Management) Module:** Company fleet management with 4 sub-modules: Fleet Dashboard (3 metric cards: Total Vehicles/Vehicles On Trip/In Maintenance, pie chart for Fleet Status breakdown Available|On Trip|Maintenance, Upcoming Expiries panel showing RC/Insurance expiring within 30 days), Vehicle Directory (data table with Reg Number/Type/Make & Model/Status/RC Expiry/Insurance Expiry, color-coded status badges: green Available/blue On Trip/amber Maintenance, Add Vehicle modal with Registration Number/Type Truck|Van|Car/Make/Model/Status/RC Expiry/Insurance Expiry, search filter), Dispatch & Trips (trip table with Trip ID/Vehicle/Driver/Route origin→destination/Start/End/Status, filter tabs: All|Scheduled|In Transit|Completed, New Dispatch modal assigns Vehicle dropdown showing available vehicles/Driver/Origin/Destination/Start Time/Status, inline Start/Complete action buttons that auto-update vehicle status: dispatching sets vehicle to On Trip, completing resets to Available), Fuel & Maintenance Logs (expense table with Date/Vehicle Reg No/Expense Type/Amount ₹/Description/Logged By/Delete, 3 summary cards showing totals for Fuel/Repair/Servicing, Add Expense modal with Vehicle dropdown/Type Fuel|Repair|Servicing/Amount/Date/Logged By/Description, search filter). DB tables: fleet_vehicles, fleet_trips, fleet_expenses (integer FK to fleet_vehicles). API: /api/fleet/* endpoints (dashboard, vehicles CRUD, trips CRUD with status transitions, expenses CRUD).
